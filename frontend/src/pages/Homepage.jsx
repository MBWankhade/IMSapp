      ...
      <>
        ...
        <div className="p-24 flex flex-col items-center">
          ...
          <div className="flex items-center justify-between p-12">
            <p className="text-3xl w-1/2">
              <strong>Audio and Video Calls: </strong>Communicate seamlessly
        ...
        <div className="p-24 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center justify-center p-12 gap-12">
            ...
            <p className="text-3xl">
              <strong>Collaborate and Practice:</strong> Use our tools to
            ...
            <div className="flex flex-wrap justify-between">
              ...
              <div className="w-full sm:w-1/3 mb-6 sm:mb-0">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="https://www.instagram.com/manthankhawse/"
                    className="text-3xl"
                  >
                    <FaInstagramSquare />
                  </a>
              ...
              <div className="w-full sm:w-1/3">
                ...
                <p>Email: info@mockinterview.com</p>
                <p>Phone: +123 456 7890</p>
                <p>Address: 123 Main Street, City, Country</p>
              </div>
            </div>
            <div className="text-center mt-8">
              <p>&copy; 2024 MockInterview. All rights reserved.</p>
            </div>
          </div>
        </div>
      </>
